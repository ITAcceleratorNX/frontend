...
import { Shield, Send, History } from 'lucide-react';
        ...
        <div className="px-6 py-4 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-r from-[#1e2c4f] to-[#3b82f6] rounded-lg flex items-center justify-center">
                <Shield className="w-5 h-5 text-white" />
              </div>
              <div>
                <h2 className="text-xl font-semibold text-gray-900">Панель администратора</h2>
                <p className="text-sm text-gray-600">Полное управление уведомлениями</p>
              </div>
            </div>
          </div>
        </div>
