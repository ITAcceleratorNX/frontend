...
export const RegisterForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      console.log('RegisterForm: Ответ от сервера:', response);
      
      // Правильно проверяем успешный ответ от сервера
      if (response && response.data && response.data.success) {
        ...
        const errorMessage = response?.data?.message || 'Ошибка при регистрации. Пожалуйста, попробуйте снова.';
