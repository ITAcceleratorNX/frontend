...
const InputButtonContext = React.createContext(undefined);
    ...
    <InputButtonContext.Provider
      ...
      <div
        ...
        className={cn(
          ...
          (showInput || localShowInput) && 'w-full max-w-[800px]',
          className
        )}
        {...props} />
    </InputButtonContext.Provider>
...
function InputButtonSubmit({
  ...
  return (
    <motion.button
      ...
      transition={transition}
      className={cn(
        "z-[1] [&_svg:not([class*='size-'])]:size-4 cursor-pointer disabled:pointer-events-none disabled:opacity-50 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive whitespace-nowrap bg-[#273655] hover:bg-[#324569] transition-colors text-white rounded-full text-sm flex items-center justify-center font-medium absolute inset-y-1 right-1",
...
export { InputButton, InputButtonProvider, InputButtonAction, InputButtonSubmit, InputButtonInput, useInputButton };
