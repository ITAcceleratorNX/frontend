  ...
  return (
    <div className="font-['Montserrat'] min-h-screen bg-white flex flex-col">
      ...
      <section className="w-full bg-white py-8 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-belcanto text-2xl sm:text-4xl md:text-5xl lg:text-6xl text-[#202422] font-normal text-center mb-3 sm:mb-4">
            ФОРМАТЫ ХРАНЕНИЯ
          </h2>
          <p className="text-[#5C625F] text-sm sm:text-base text-center max-w-2xl mx-auto mb-8 sm:mb-16 px-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center mb-10 sm:mb-16 lg:mb-20">
            <div className="order-2 lg:order-1 w-full max-w-lg aspect-[4/3] overflow-hidden rounded-xl sm:rounded-2xl mx-auto lg:mx-0 lg:ml-24">
              <img
                src={indiImg}
            ...
            <div className="order-1 lg:order-2 text-center sm:text-left">
              <h3 className="text-xl sm:text-3xl font-bold text-[#202422] mb-3 sm:mb-4">Индивидуальное хранение</h3>
              <p className="text-[#5C625F] text-sm sm:text-base mb-3 sm:mb-4">
                Ваш личный закрытый бокс. Только вы имеете доступ — как мини-склад под ключ.
              </p>
              <ul className="space-y-2 mb-4 sm:mb-6">
                <li className="flex items-center gap-2 text-[#5C625F] text-sm sm:text-base justify-center sm:justify-start">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 text-[#31876D] font-medium hover:opacity-80 transition-opacity touch-manipulation py-2"
              >
                <span>Подробнее</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            <div className="w-full max-w-lg aspect-[4/3] overflow-hidden rounded-xl sm:rounded-2xl mx-auto lg:mx-0 lg:ml-24">
              <img
                src={oblachImg}
            ...
            <div className="text-center sm:text-left">
              <h3 className="text-xl sm:text-3xl font-bold text-[#202422] mb-3 sm:mb-4">Облачное хранение</h3>
              <p className="text-[#5C625F] text-sm sm:text-base mb-3 sm:mb-4">
      ...
      <section ref={tabsSectionRef} className="w-full bg-[#FFF] py-6 sm:py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          {/* Заголовок */}
          <h2 className="font-belcanto text-2xl sm:text-4xl md:text-5xl lg:text-6xl text-[#202422] font-normal mb-4 sm:mb-6">
            ХРАНЕНИЕ В ГОРОДЕ
          </h2>
          
          {/* Описания на одном уровне */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 lg:gap-8 items-start mb-6 sm:mb-8">
            <p className="text-[#5C625F] text-sm sm:text-base lg:text-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
            <button
              ...
              className={`px-4 sm:px-6 py-3 rounded-xl text-sm sm:text-base font-semibold transition-all touch-manipulation text-center ${
