    ...
    <div className="w-full max-w-6xl mx-auto p-8 space-y-6">
      ...
      <Card className="bg-white rounded-2xl border border-[#E0F2FE]">
        <CardHeader>
          ...
          <p className="text-sm text-[#8A8A8A]">Включение или отключение онлайн-оплаты (Tip Top pay). При выключении клиенты видят контакты менеджера, оплату подтверждаете вручную в разделе ниже.</p>
        </CardHeader>
        <CardContent>
          {settingsLoading ? (
