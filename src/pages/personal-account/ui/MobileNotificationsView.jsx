  ...
  return (
    <div className="min-w-0">
        <div className="flex items-center justify-between gap-2 mb-2">
            <h1 className="text-base min-[360px]:text-xl sm:text-2xl font-semibold text-[#363636] break-words">
                Уведомления
            </h1>

            {unread > 0 && (
                <label className="flex items-center gap-2 cursor-pointer select-none">
                <span className="text-xs min-[360px]:text-sm text-gray-700">
                ...
                <div className="relative">
                    ...
                    />
                    <div className="w-9 h-5 bg-gray-300 rounded-full peer-checked:bg-[#00A991] transition-colors" />
      ...
      {filteredNotifications.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-10 min-[360px]:py-12 px-3 bg-white rounded-[25px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.08)]">
          ...
          <p className="text-sm min-[360px]:text-base font-medium text-gray-700 mb-1">
