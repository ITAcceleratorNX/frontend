        ...
        <main className="flex-1 mr-[110px]">
          <div className="max-w-5xl mx-auto py-12 px-10">
            <div className="flex items-center mb-8">
              <button onClick={() => navigate('/personal-account', { state: { activeSection: 'deliveryrequest' } })} className="mr-4 p-2 rounded-full hover:bg-gray-100 transition-colors">
            ...
            <div className="bg-white p-8">
              <div className="font-semibold text-base text-[#222] mb-2">
                ...
                {order.status === 'wait' && (
                  <button className="bg-[#263554] text-white text-xs font-medium rounded px-2 py-1 ml-[50px] w-fit">
                    Принять
                  </button>
                )}
                {order.status === 'active' && (
...
export default DeliveryRequestOrder;
