...
// Удаляем неиспользуемые импорты изображений
...
const orders = [
  ...
  { id: 125, date: 'Mar 3, 2025', status: 'active', user: null },
  { id: 122, date: 'Mar 3, 2025', status: 'active', user: null },
  { id: 124, date: 'Mar 3, 2025', status: 'active', user: null },
  { id: 126, date: 'Mar 3, 2025', status: 'active', user: null },
  { id: 123, date: 'Mar 3, 2025', status: 'done', user: null },
  { id: 121, date: 'Mar 3, 2025', status: 'done', user: null },
];
        ...
        <main className="flex-1 mr-[110px]">
          <div className="max-w-5xl mx-auto py-12 px-10">
            <div className="flex items-center mb-8">
              <button onClick={() => navigate('/personal-account', { state: { activeSection: 'adminmoving' } })} className="mr-4 p-2 rounded-full hover:bg-gray-100 transition-colors">
