...
const TARIFFS = [
  ...
  },
  {
    ...
    volume: '0.5 м³',
    price: '5 000 ₸/мес',
    description: 'Храните комплект шин до следующего сезона — без необходимости занимать место дома.',
  },
  {
    Icon: Bike,
    title: 'Мотоцикл',
...
const COMPARISON = [
  {
    ...
    cloud: 'Можно организовать отдельно',
  },
  {
...
const B2B_OFFERINGS = [
  ...
  'Выдача вещей по запросу, доставка при необходимости организуется отдельно',
];
...
const STEPS = [
  ...
  },
  {
    ...
    text: 'При необходимости поможем организовать обратную доставку. Стоимость рассчитывается отдельно.',
  },
];
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Поможем организовать доставку по запросу. Стоимость и сроки рассчитываются отдельно в зависимости от объёма вещей и адреса.',
  },
  {
...
export default function OblachnoeHranenieAlmatyPage() {
  ...
  return (
    ...
    >
      <LpHelmet
        title="Облачное хранение в Алматы без отдельного бокса · ExtraSpace"
        description="Платите за объём, а не за целый бокс. Храним вещи на складе и возвращаем по запросу. От 6 000 ₸ в месяц. Для частных лиц и бизнеса."
        canonical={CANONICAL}
      ...
      <section className="lp-hero-min-h relative isolate flex flex-col items-center justify-center overflow-hidden bg-[#0e1729] px-4 py-10 text-white sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        ...
        <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          <h1 className="font-soyuz-grotesk text-[26px] font-bold leading-[1.1] xs:text-[28px] sm:text-4xl md:text-5xl lg:text-6xl">
            Облачное хранение без аренды отдельного бокса
          </h1>
          <p className="mt-4 max-w-2xl text-sm text-white/85 sm:mt-5 sm:text-base md:text-lg">
            Платите за объём, а не за целый бокс. Храним ваши вещи на складе и возвращаем по запросу — от 1 месяца.
          </p>
      ...
      <section id="sravnenie" className="w-full bg-[#F7FAF9] py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <header className="mx-auto mb-10 max-w-2xl text-center">
            ...
            <p className="mt-3 text-sm text-[#555A65] sm:text-base">
              Облачное хранение — это хранение вещей без аренды отдельного бокса. Сравните с индивидуальным хранением, чтобы выбрать подходящий формат.
            </p>
          </header>
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            <article id="dlya-doma" className="flex flex-col gap-4 rounded-3xl border border-[#e5e9ed] bg-[#F7FAF9] p-6 sm:p-8">
              ...
              <p className="text-sm text-[#4b5563]">
                Идеально, если дома мало места, а вещи нужны только время от времени. Храним их на складе и возвращаем по запросу.
              </p>
          ...
          <div className="mx-auto grid max-w-3xl gap-3 sm:grid-cols-2">
            <div className="flex items-start gap-3 rounded-3xl border border-[#e5e9ed] bg-[#F7FAF9] p-5">
              ...
              <div>
                ...
                <p className="text-sm text-[#6b7280]">Стоимость рассчитывается отдельно в зависимости от объёма вещей и адреса.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 rounded-3xl border border-[#e5e9ed] bg-[#F7FAF9] p-5">
      ...
      <MiniFormSection
        serviceType={SERVICE_TYPE}
        title="Оставьте заявку на облачное хранение"
        description="Напишем в WhatsApp в течение 15 минут. Менеджер уточнит объём вещей, рассчитает стоимость хранения и при необходимости поможет организовать доставку."
        showClientType
      ...
      <section className="relative isolate w-full overflow-hidden bg-[#0e1729] py-12 text-white sm:py-16 lg:py-24">
        ...
        <div className="container relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="font-soyuz-grotesk text-2xl font-bold leading-tight xs:text-3xl sm:text-4xl lg:text-5xl">
            Храните вещи — получайте их по запросу
          </h2>
          <p className="mt-4 text-sm text-white/80 sm:text-base">
            Платите только за фактический объём хранения. При необходимости поможем организовать доставку вещей на склад и обратно — её стоимость рассчитывается отдельно.
          </p>
