...
const ProgressCircle = ({ step }) => {
    ...
    return (
        <svg
            ...
            height="auto"
            viewBox="0 0 260 260"
            className="max-w-[260px] w-full block mx-auto"
        >
            <circle
                cx={130}
                cy={130}
...
const StepperForm = () => {
    ...
    return (
        <div className="max-w-[900px] mx-auto w-full px-4 mt-16 mb-24 flex flex-col items-center">
            ...
            {/* Форма под прогрессом */}
            <div className="bg-white rounded-xl shadow p-8 w-full max-w-[420px] border border-[#E6E9F5]">
                {step === 0 && (
                    <form
                        onSubmit={e => {
                            e.preventDefault();
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#273655] text-white rounded py-2 font-bold text-lg mt-2 disabled:opacity-50"
                            disabled={!city}
                        >
                            Продолжить
                        </button>
                            ...
                            <div className="flex gap-4 flex-col sm:flex-row">
                                {types.map(t => (
                                    <button
                                        type="button"
                                        key={t.value}
                                        className={`h-[56px] rounded-lg text-[16px] w-full sm:w-1/2 font-bold font-['Montserrat'] transition-colors ${
                                            type === t.value
                ...
                {step === 3 && (
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#273655] text-white rounded py-2 font-bold text-lg mt-2"
                        >
                            Продолжить
                        </button>
                    </form>
        ...
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <section className="relative w-full h-[500px] mt-5 flex items-center justify-center">
                <img
                    src={mainImg}
                    alt="Delivery Truck"
                    className="absolute inset-0 w-full h-[414px] top-20 object-cover z-10"
                />
            ...
            <section className="w-full flex flex-col items-center justify-center -mt-[165px] pt-[150px] font-['DM Sans'] px-4">
                ...
                <p className="text-[#273655] text-left max-w-[720px] mb-8 text-[16px] sm:text-[18px] leading-snug">
                    В любой точке Алматы наши специалисты приедут, упакуют, погрузят и доставят ваши вещи на склад хранения. Вам
                    не нужно беспокоиться о разборке мебели — мы предоставляем полный комплекс услуг по мувингу и хранению вещей.
                    Ваши вещи под надежной защитой.
                </p>
