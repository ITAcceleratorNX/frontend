...
const CabinetPage = () => {
  ...
  const { logout, isAuthenticated: authIsAuthenticated, user: authUser } = useAuth();
  const { user: sessionUser, isAuthenticated: sessionIsAuthenticated } = useSessionStore();
  ...
  // Используем данные пользователя из обоих источников
  ...
  }, [isAuthenticated, navigate, user, authIsAuthenticated, sessionIsAuthenticated]);
