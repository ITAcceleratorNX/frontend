            ...
            <div className="flex-1 font-['Montserrat'] text-[#273655]">
              ...
              <section id="section1" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-4 leading-relaxed">
                  <p>
                    Наш сайт подключен к интернет-эквайрингу, и Вы можете оплатить услугу банковской картой Visa или Mastercard, а также с помощью Apple Pay и Google Pay. После подтверждения выбранной услуги откроется защищенное окно с платежной страницей процессингового центра TipTop Pay, где Вам необходимо ввести данные Вашей банковской карты.
                  </p>
                  <p>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Переход на защищенную платежную страницу процессингового центра TipTop Pay;</li>
              ...
              <section id="section2" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-4 leading-relaxed">
                  <p>
                    Процессинговый центр TipTop Pay защищает и обрабатывает данные Вашей банковской карты по стандарту безопасности PCI DSS Level 1. Это международный стандарт безопасности данных индустрии платежных карт, который обеспечивает высокий уровень защиты информации о платежах.
                  </p>
                  <p>
                  ...
                  <p>
                    TipTop Pay не передает данные Вашей карты третьим лицам. Вся информация обрабатывается в соответствии с требованиями безопасности и используется исключительно для проведения платежных операций.
                  </p>
                  <p>
                    Ввод данных осуществляется в защищенном окне на платежной странице TipTop Pay. Данные Вашей банковской карты не сохраняются на серверах сайта ExtraSpace и не передаются нам. Вся обработка платежных данных происходит на стороне процессингового центра.
                  </p>
                  <p>
              ...
              <section id="section4" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-4 leading-relaxed">
                  ...
                  <p>
                    Вся информация передается в зашифрованном виде и не хранится на сервере сайта. Данные Вашей банковской карты обрабатываются исключительно процессинговым центром TipTop Pay и не сохраняются в системе ExtraSpace.
                  </p>
                  <p>
