...
const FloatingWhatsAppButton = memo(() => {
  ...
  useEffect(() => {
    const updateVisibility = () => {
      ...
      const heroBottomThreshold = heroSection
        ? Math.max(120, heroSection.offsetHeight - 80)
        : Math.max(320, window.innerHeight - 80);

      setIsVisible(window.scrollY > heroBottomThreshold);
    };
