        ...
        <div className="flex flex-col gap-6 rounded-3xl bg-white p-6 sm:p-8">
          ...
          <div className="flex flex-col gap-4 rounded-2xl bg-[#F5F6FA] p-4 text-sm text-[#273655]">
            <div className="flex items-center">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white shadow-sm mr-3">
              ...
              <a
                ...
                className="flex items-center justify-center transition hover:scale-110 ml-1 mr-3"
                aria-label="Написать в WhatsApp"
              >
                <svg width="42" height="42" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="text-[#128C7E]">
